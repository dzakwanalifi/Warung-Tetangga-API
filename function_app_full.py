...
# Import full production FastAPI app
fastapi_app = None
import_error = None
...
try:
    ...
    from app.main_production_full import app as fastapi_app
    logger.info("✅ Full production FastAPI app imported successfully")
except Exception as e:
    import_error = str(e)
    logger.error(f"❌ Failed to import full production FastAPI app: {e}")
        ...
        if route == '' or route == '/':
            return func.HttpResponse(
                json.dumps({
                    ...
                    "note": "FastAPI app failed to import"
                }),
                status_code=503,
