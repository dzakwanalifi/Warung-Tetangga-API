# deploy-production.ps1 - Production Azure Functions Deployment (Full FastAPI)

Write-Host "Starting Production Azure Functions Deployment (Full FastAPI)" -ForegroundColor Green
...
# Step 2: Use production setup
Write-Host "Setting up production configuration..." -ForegroundColor Yellow
Copy-Item "function_app_production.py" "function_app.py" -Force
