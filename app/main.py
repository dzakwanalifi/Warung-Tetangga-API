...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://localhost", "https://app.warungwarga.com"], # Ganti dengan URL frontend Anda
...
async def read_root():
    ...
    """
    return {"message": "Welcome to Warung Warga API v1.0.0"}
